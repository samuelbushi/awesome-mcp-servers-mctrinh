...
* [UIZZE](https://github.com/uizze/uizze-mcp) - A UI reference MCP for Codex, Claude Code, and Cursor that grounds UI work in a catalogue of 800,000+ real web and iOS screens, produces a product-specific design contract, and runs a finish-gate review before shipping via [UIZZE](https://uizze.com).
